package com.test.springboot.utils.result;
...
import com.test.springboot.utils.result.code.Errs;
...
public class DataResult<E> implements Code {
	...
	private  boolean stat_emp;

	public boolean isStat_emp() {
		return stat_emp;
	}

	public void setStat_emp(boolean stat_emp) {
		this.stat_emp = stat_emp;
	}
